...
public class InformacionGrupo extends javax.swing.JFrame {
    ...
    public InformacionGrupo(Menu_Admin frame, String idGrupo) {
        initComponents();
        ...
        ObjGrupos.obtenerClasesGrupo(t_clases, idGrupo);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("INFORMACIÓN GRUPO");
        ...
        jLabel13.setText("CLASES DEL GRUPO");
        ...
        t_clases.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "MATERIA", "DOCENTE", "HORA", "CARRERA", "ALUMNOS INSCRITOS"
            }
        ) {
        ...
        jScrollPane1.setViewportView(t_clases);
        if (t_clases.getColumnModel().getColumnCount() > 0) {
            t_clases.getColumnModel().getColumn(0).setMinWidth(50);
            t_clases.getColumnModel().getColumn(0).setMaxWidth(50);
            t_clases.getColumnModel().getColumn(3).setMinWidth(100);
            t_clases.getColumnModel().getColumn(3).setMaxWidth(100);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InformacionGrupo(null, null).setVisible(true);
            }
        });
    }
